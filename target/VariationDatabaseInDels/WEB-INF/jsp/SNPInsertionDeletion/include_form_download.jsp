...
<form:form action="${pageContext.request.contextPath}/download" commandName="dtoDownload" method="POST">
    ...
    <fieldset>
        ...
        <form:hidden path="searchReferenceBreed" />
        <form:hidden path="searchAlternativeBreed" />
        ...
        <div class="row">
            ...
            <form:label path="DownloadFormat"><h4><spring:message code="snpinsertiondeletion.download.format.label"/></h4></form:label>
                <div class="row-fluid">
                    <div class="span8">
            ...
            <form:label path="DownloadQuotes"><h4><spring:message code="snpinsertiondeletion.download.quotes.label"/></h4></form:label>
        ...
        <div class="row">
            ...
            <form:label path="DownloadHeaders"><h4><spring:message code="snpinsertiondeletion.download.headers.label"/></h4></form:label>
                <div class="row-fluid">
                    <div class="span8">
