...
<form:form action="${pageContext.request.contextPath}/upload" commandName="dtoSearch" enctype="multipart/form-data" method="POST">
    ...
    <fieldset>
        ...
        <legend><spring:message code="snpinsertiondeletion.upload.form.legend"/></legend>
        ...
        <div class="row">
            <div class="span4">
                ...
                <div>
        <h3><spring:message code="snpinsertiondeletion.upload.form.subtitle0"/></h3>
                </div><!-- close spacer --> 
        ...
        <div class="row">
            <div class="span4">
                ...
                <div>
            <form:label path="searchUploadFile"><spring:message code="snpinsertiondeletion.search.upload.label"/>
            </form:label>
        ...
        <div class="row spacer">
            <div class="span12">
                <input type="submit" value="<spring:message code="snpinsertiondeletion.search.upload.submit.label"/>"/>
            </div><!-- close span12 -->
