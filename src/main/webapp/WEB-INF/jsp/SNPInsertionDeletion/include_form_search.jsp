...
$("#searchGeneName").autocomplete("${pageContext.request.contextPath}/getEnsemblIds.jsp");
        ...
        <div id="legend1">
        <legend><spring:message code="snpinsertiondeletion.search.filter.form.legend"/></legend>
        </div>
        ...
        <div class="row">
            <div class="span4">
                ...
                <div>
        <h3><spring:message code="snpinsertiondeletion.search.filter.form.subtitle0"/></h3>
        <!-- <p><strong><spring:message code="snpinsertiondeletion.search.filter.form.subtitle1"/></strong></p> -->
                </div><!-- close spacer --> 
...
<div class="row spacer">
<div class="span4">
            <form:label path="searchFilterSiftScoreValue"><spring:message code="snpinsertiondeletion.search.filter.searchFilterSiftScore.label"/>
...
<div class="row spacer">
<div class="span4">
            <form:label path="searchFilterProveanScoreValue"><spring:message code="snpinsertiondeletion.search.filter.searchFilterProveanScore.label"/>
...
<div class="row spacer">
<div class="span4">
            <form:label path="searchFilterSiftConservationScoreValue"><spring:message code="snpinsertiondeletion.search.filter.searchFilterSiftConservationScore.label"/>
...
<div class="row spacer">
<div class="span4">
            <form:label path="searchFilterProteinAlignNumberValue"><spring:message code="snpinsertiondeletion.search.filter.searchFilterProteinAlignNumber.label"/>
...
<div class="row spacer">
<div class="span4">
            <form:label path="searchFilterTotalNumberSeqAlignedValue"><spring:message code="snpinsertiondeletion.search.filter.searchFilterTotalNumberSeqAligned.label"/>
